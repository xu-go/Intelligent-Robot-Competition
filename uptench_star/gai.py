...
class main_demo:
    ...
    def start_match(self):
        ...
        while 1:
            #检测是否在台上
            # 0为在台下�?1为在台上�?5�?8个光电都为检测到
            stage = self.paltform_detect()
            #在台�?,一级判�?
            if stage == 0:
                #收爪�?
                self.default_platform()         
                print("stage",stage,"在台�?")
                ...
                while (not_on_stage == 1):
                    ...
                    print("底部的光电状�?",basee)
                    print("是否未彻底登上台,1�?,0�?",not_on_stage)
                    ...
                    while(self.cliff() == 4):
                        ...
                        #在台�?    
                            ...
                            #前方有敌人、能量块或者炸弹三级判�?
                                ...
                                #能量块时四级判断
                                #蓝方能量块为�?1”，黄方能量块为�?2”，中立能量块为�?0�?,别推自己�?
                                #our_side = 0黄方
                                #our_side = 1蓝方
                                #决赛视频时能量块为�?1�?,炸弹为�?0�?
                                #蓝方能量�?1
                                ...
                                #当id识别不到东西的时�?,可能时敌方机器人，不排除视觉寄了的情况四级判�?
                                elif id == None:
                                    print("不知道是什么东�?,可能是敌人或大障碍物")
                                    #前进
                                    self.controller.move_cmd(950, 950)
